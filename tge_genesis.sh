...
NOW=$(date +%s)
let TGE_START_DATE_TS="$NOW + 60"  # TGE START DATE
DAY=86400
...
LOCKDROP_LOCK_WINDOW_SECONDS=120  # 86400 * 3
LOCKDROP_WITHDRAWAL_WINDOW_SECONDS=60  # 86400 * 2
LOCKDROP_MIN_LOCK_DURATION_SECONDS=259200  # 86400 * 30 * 3
LOCKDROP_MAX_LOCK_DURATION_SECONDS=2592000  # 86400 * 30 * 12
LOCKDROP_MAX_POSITIONS_PER_USER=1000
LOCKDROP_NTRN_INCENTIVES_U_NTRN=10000000000000untrn

AUCTION_DEPOSIT_WINDOW_SECONDS=120
AUCTION_WITHDRAWAL_WINDOW_SECONDS=60
...
AUCTION_VESTING_LP_DURATION=259200
...
LP_VESTING_VAULT_BINARY=$DAO_CONTRACTS_BINARIES_DIR/vesting_lp_vault.wasm
...
LP_VESTING_VAULT_BINARY_ID=$(store_binary "$LP_VESTING_VAULT_BINARY" "$NEUTRON_DAO_ADDRESS")
...
ASTROPORT_VESTING_BINARY_ID=$(store_binary "$ASTROPORT_VESTING_BINARY" "$ASTROPORT_MULTISIG_ADDRESS")
ASTROPORT_WHITELIST_BINARY_ID=$(store_binary "$ASTROPORT_WHITELIST_BINARY" "$ASTROPORT_MULTISIG_ADDRESS")
...
ASTROPORT_VESTING_CONTRACT_ADDRESS=$(generate_contract_address $ASTROPORT_VESTING_BINARY_ID) && ((INSTANCE_ID_COUNTER++))
...
((INSTANCE_ID_COUNTER++))
LP_VESTING_VAULT_CONTRACT_ADDRESS=$(generate_contract_address $LP_VESTING_VAULT_BINARY_ID) && ((INSTANCE_ID_COUNTER++))
...
instantiate_contract $ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_BINARY_ID "$ASTROPORT_NATIVE_COIN_REGISTRY_INIT_MSG" "ASTROPORT_NATIVE_COIN_REGISTRY" "$ASTROPORT_MULTISIG_ADDRESS"
execute_contract $ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_ADDRESS "$SET_UNTRN_PRECISION_MSG" "$ASTROPORT_MULTISIG_ADDRESS"
instantiate_contract $ASTROPORT_FACTORY_CONTRACT_BINARY_ID "$ASTROPORT_FACTORY_INIT_MSG" "ASTROPORT_FACTORY" "$ASTROPORT_MULTISIG_ADDRESS"

LOCKDROP_LOCKUP_REWARDS_INFO='[
  {"duration": '$LOCKDROP_MIN_LOCK_DURATION_SECONDS', "coefficient": "0"},
  {"duration": '$LOCKDROP_MAX_LOCK_DURATION_SECONDS', "coefficient": "2"}
]'
...
instantiate_contract $ASTROPORT_VESTING_BINARY_ID "$ASTROPORT_VESTING_INIT_MSG" "astroport_vesting" "$ASTROPORT_MULTISIG_ADDRESS"
...
ASTROPORT_GENERATOR_INIT_MSG='{
  ...
  "owner": "'"$TOKEN_INFO_MANAGER_MULTISIG_ADDRESS"'",
  "start_block": "1",
  "tokens_per_block": "100",
  "vesting_contract": "'"$ASTROPORT_VESTING_CONTRACT_ADDRESS"'",
  "whitelist_code_id": '$ASTROPORT_WHITELIST_BINARY_ID'
}'

instantiate_contract $ASTROPORT_GENERATOR_CONTRACT_BINARY_ID "$ASTROPORT_GENERATOR_INIT_MSG" "astroport_generator" "$TOKEN_INFO_MANAGER_MULTISIG_ADDRESS"
instantiate_contract $LP_VESTING_VAULT_BINARY_ID "$LP_VESTING_VAULT_INIT_MSG" "lp_vesting_vault" "$NEUTRON_DAO_ADDRESS"
...
ASTROPORT_ASTRO_VESTING_SETUP_MSG='
{
  "register_vesting_accounts": {
    "vesting_accounts": [
      {
        "address": "'"${ASTROPORT_GENERATOR_CONTRACT_ADDRESS}"'",
        "schedules": [
          {
           "start_point": {
            "time":0,
...
echo "" > contracts.txt
echo "LOCKDROP_CONTRACT_ADDRESS="$LOCKDROP_CONTRACT_ADDRESS >> contracts.txt
echo "AUCTION_CONTRACT_ADDRESS="$AUCTION_CONTRACT_ADDRESS >> contracts.txt
echo "CREDITS_CONTRACT_ADDRESS="$CREDITS_CONTRACT_ADDRESS >> contracts.txt
echo "AIRDROP_CONTRACT_ADDRESS="$AIRDROP_CONTRACT_ADDRESS >> contracts.txt
echo "PRICE_FEED_CONTRACT_ADDRESS="$PRICE_FEED_CONTRACT_ADDRESS >> contracts.txt
echo "USDC_TWAP_CONTRACT_ADDRESS="$USDC_TWAP_CONTRACT_ADDRESS >> contracts.txt
echo "ATOM_TWAP_CONTRACT_ADDRESS="$ATOM_TWAP_CONTRACT_ADDRESS >> contracts.txt
echo "USDC_LP_VESTING_CONTRACT_ADDRESS="$USDC_LP_VESTING_CONTRACT_ADDRESS >> contracts.txt
echo "ATOM_LP_VESTING_CONTRACT_ADDRESS="$ATOM_LP_VESTING_CONTRACT_ADDRESS >> contracts.txt
echo "CREDITS_VAULT_CONTRACT_ADDRESS="$CREDITS_VAULT_CONTRACT_ADDRESS >> contracts.txt
echo "LOCKDROP_VAULT_CONTRACT_ADDRESS="$LOCKDROP_VAULT_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_SATELLITE_CONTRACT_ADDRESS="$ASTROPORT_SATELLITE_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_FACTORY_CONTRACT_ADDRESS="$ASTROPORT_FACTORY_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_ADDRESS="$ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_SATELLITE_CONTRACT_BINARY_ID="$ASTROPORT_SATELLITE_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_GENERATOR_CONTRACT_BINARY_ID="$ASTROPORT_GENERATOR_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_GENERATOR_CONTRACT_ADDRESS="$ASTROPORT_GENERATOR_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_FACTORY_CONTRACT_BINARY_ID="$ASTROPORT_FACTORY_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_BINARY_ID="$ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_PAIR_CONTRACT_BINARY_ID="$ASTROPORT_PAIR_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_TOKEN_CONTRACT_BINARY_ID="$ASTROPORT_TOKEN_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_VESTING_CONTRACT_BINARY_ID="$ASTROPORT_VESTING_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_MAKER_CONTRACT_BINARY_ID="$ASTROPORT_MAKER_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_ROUTER_CONTRACT_BINARY_ID="$ASTROPORT_ROUTER_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_PAIR_STABLE_CONTRACT_BINARY_ID="$ASTROPORT_PAIR_STABLE_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_PAIR_CL_CONTRACT_BINARY_ID="$ASTROPORT_PAIR_CL_CONTRACT_BINARY_ID >> contracts.txt
echo "ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_ADDRESS="$ASTROPORT_NATIVE_COIN_REGISTRY_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_SATELLITE_CONTRACT_ADDRESS="$ASTROPORT_SATELLITE_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_FACTORY_CONTRACT_ADDRESS="$ASTROPORT_FACTORY_CONTRACT_ADDRESS >> contracts.txt
echo "VESTING_INVESTORS_CONTRACT_ADDRESS="$VESTING_INVESTORS_CONTRACT_ADDRESS >> contracts.txt
echo "VESTING_INVESTORS_WITHOUT_VOTING_POWER_CONTRACT_ADDRESS="$VESTING_INVESTORS_WITHOUT_VOTING_POWER_CONTRACT_ADDRESS >> contracts.txt
echo "VESTING_LTI_CONTRACT_ADDRESS="$VESTING_LTI_CONTRACT_ADDRESS >> contracts.txt
echo "ASTROPORT_VESTING_CONTRACT_ADDRESS="$ASTROPORT_VESTING_CONTRACT_ADDRESS >> contracts.txt
echo "INVESTORS_VESTING_VAULT_CONTRACT_ADDRESS="$INVESTORS_VESTING_VAULT_CONTRACT_ADDRESS >> contracts.txt
echo "LP_VESTING_VAULT_CONTRACT_ADDRESS="$LP_VESTING_VAULT_CONTRACT_ADDRESS >> contracts.txt
echo "LP_VESTING_VAULT_BINARY_ID="$LP_VESTING_VAULT_BINARY_ID >> contracts.txt
