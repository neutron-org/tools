...
CHAIN_START=1681898400 # 19 apr 13:00 GMT+3

# ------------------------------------------------CONTRACT INIT PARAMS-------------------------------------------------
LOCKDROP_LOCK_WINDOW=3600
LOCKDROP_WITHDRAWAL_WINDOW=3600 # 0.5 hours
...
let AUCTION_INIT_TIMESTAMP="$CHAIN_START + 1 * 60 * 60"
let LOCKDROP_INIT_TIMESTAMP="$AUCTION_INIT_TIMESTAMP + $AUCTION_DEPOSIT_WINDOW + $AUCTION_WITHDRAWAL_WINDOW"

AUCTION_DEPOSIT_WINDOW=3600 
AUCTION_WITHDRAWAL_WINDOW=3600 
AUCTION_MAX_EXCHANGE_RATE_AGE=3600 
...
INVESTORS_VESTING_VAULT_BINARY_ID=$(store_binary "$INVESTORS_VESTING_VAULT_BINARY" "$MAIN_DAO_ADDRESS")
...
instantiate_contract $INVESTORS_VESTING_VAULT_BINARY_ID "$INVESTORS_VESTING_VAULT_MSG" "VESTING_LTI" "$MAIN_DAO_ADDRESS"
