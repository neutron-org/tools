...
TGE_START_DATE_TS=1683111600  # 11 May 00:00 UTC
DAY=3600

# ------------------------------------------------CONTRACT INIT PARAMS-------------------------------------------------
LOCKDROP_LOCK_WINDOW_SECONDS=3600  # 86400 * 5
LOCKDROP_WITHDRAWAL_WINDOW_SECONDS=3600  # 86400 * 2
LOCKDROP_MIN_LOCK_DURATION_SECONDS=600  # 86400 * 30 * 3
LOCKDROP_MAX_LOCK_DURATION_SECONDS=3600  # 86400 * 30 * 12
LOCKDROP_MAX_POSITIONS_PER_USER=1000
LOCKDROP_NTRN_INCENTIVES=20000000000000

AUCTION_DEPOSIT_WINDOW_SECONDS=3600  # 86400 * 5
AUCTION_WITHDRAWAL_WINDOW_SECONDS=3600  # 86400 * 2
...
AUCTION_VESTING_LP_DURATION=$((3600))
