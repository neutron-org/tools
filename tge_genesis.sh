...
LOCKDROP_WITHDRAWAL_WINDOW=7200 # 2 hours
LOCKDROP_MIN_LOCK_DURATION=600  # 10 minutes
LOCKDROP_MAX_LOCK_DURATION=3600 # 1 hour
LOCKDROP_MAX_POSITIONS_PER_USER=1000
LOCKDROP_NTRN_INCENTIVES=50000000000untrn

AUCTION_LP_TOKENS_LOCK_WINDOW=3600 #1 hour
AUCTION_INIT_TIMESTAMP=1680867000 #14:30
AUCTION_DEPOSIT_WINDOW=3600 #1 hour
AUCTION_WITHDRAWAL_WINDOW=3600 #1 hour
AUCTION_MAX_EXCHANGE_RATE_AGE=100
AUCTION_MIN_NTRN_AMOUNT="1"
AUCTION_VESTING_MIGRATION_PACK_SIZE=100
AUCTION_VESTING_LP_DURATION=7200
AUCTION_AMOUNT=500000000untrn
