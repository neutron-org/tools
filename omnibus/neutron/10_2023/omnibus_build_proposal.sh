...
#NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_ID
  ...
  "propose": {
    "msg": {
      "propose": {
        ...
        '$(empty_migration $SECURITY_SUBDAO_PREPROPOSE $NEW_PRE_PROPOSE_SINGLE_CODE_ID)',
        '$(empty_migration $GRANTS_SUBDAO_PREPROPOSE $NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_ID)',
