...
NEW_PRE_PROPOSE_MULTIPLE_CODE_RES=$(store_code "${ARTIFACTS_DIR}/cwd_pre_propose_multiple.wasm")
...
NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_RES=$(store_code "${ARTIFACTS_DIR}/cwd_subdao_pre_propose_single.wasm")
NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_ID=$(extract_hash "$NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_RES")
echo NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_ID=$NEW_SUBDAO_PREPROPOSE_SINGLE_CODE_ID
