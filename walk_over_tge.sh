...
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"deregister": {"asset_infos": [{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"uibcatom"}}]}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"deregister": {"asset_infos": [{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"uibcusdc"}}]}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y

echo "register new ones"
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"create_pair": {"pair_type":{"custom":"concentrated"},"asset_infos":[{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"uibcatom"}}],"init_params":""}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"create_pair": {"pair_type":{"custom":"concentrated"},"asset_infos":[{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"uibcusdc"}}],"init_params":""}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y
