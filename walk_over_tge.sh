...
echo "get new pairs"
neutrond q wasm contract-state smart neutron1x85d7sktyv3ke4re90cj4nf6205a94tm4kly2dhyn3dwyhq4t56q9semue '{"pairs":{}}' --chain-id=test-1  --node $NODE
