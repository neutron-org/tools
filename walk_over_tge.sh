...
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"deregister": {"asset_infos": [{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"ibc/C4CFF46FD6DE35CA4CF4CE031E643C8FDC9BA4B99AE598E9B0ED98FE3A2319F9"}}]}}'  --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node http://localhost:26657  -y
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"deregister": {"asset_infos": [{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"ibc/F082B65C88E4B6D5EF1DB243CDA1D331D002759E938A0F5CD3FFDC5D53B3E349"}}]}}' --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node http://localhost:26657 -y

echo "register new ones"
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"create_pair": {"pair_type":{"custom":"concentrated"},"asset_infos":[{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"ibc/C4CFF46FD6DE35CA4CF4CE031E643C8FDC9BA4B99AE598E9B0ED98FE3A2319F9"}}],"init_params":""}}' --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node http://localhost:26657 -y
neutrond tx wasm execute neutron1hptk0k5kng7hjy35vmh009qd5m6l33609nypgf2yc6nqnewduqasxplt4e '{"create_pair": {"pair_type":{"custom":"concentrated"},"asset_infos":[{"native_token":{"denom":"untrn"}},{"native_token":{"denom":"ibc/F082B65C88E4B6D5EF1DB243CDA1D331D002759E938A0F5CD3FFDC5D53B3E349"}}],"init_params":""}}'  --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node http://localhost:26657 -y

echo "update generator"
neutrond tx wasm execute neutron1jz58yjay8uq8zkfw95ngyv3m2wfs2zjef9vdz75d9pa46fdtxc5sxtafny '{"setup_pools":{"pools":[["neutron18g53drwvady7kwknjauxke0za9dscv0yjyvwska2d7wsgw2gemlsl9unw8", "1"]]}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y
neutrond tx wasm execute neutron1jz58yjay8uq8zkfw95ngyv3m2wfs2zjef9vdz75d9pa46fdtxc5sxtafny '{"setup_pools":{"pools":[["neutron1uywpz5esk0r3z7p7vl2h3vnqlrchra5phkex76z0rh2pckun0x9q3lj7va", "1"]]}}' --keyring-backend=test --from=demowallet1 --chain-id=neutron-1 --gas auto --broadcast-mode block --gas-adjustment 1.5 --gas-prices 0.025untrn --node $NODE -y
