...
echo ""
echo NEW_LOCKDROP_CODE_ID=454
echo NEW_LOCKDROP_VAULT_CODE_ID=455
echo NEW_VESTING_LP_VAULT_CODE_ID=456
echo NEW_VESTING_LP_CODE_ID=457
echo NEW_RESERVE_CODE_ID=458
echo NEW_VESTING_LP_VAULT_CL_CODE_ID=459
echo NEW_LOCKDROP_VAULT_CL_CODE_ID=FILL
