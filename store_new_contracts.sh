...
echo ""
echo NEW_LOCKDROP_CODE_ID=462
echo NEW_LOCKDROP_VAULT_CODE_ID=463
echo NEW_VESTING_LP_VAULT_CODE_ID=464
echo NEW_VESTING_LP_CODE_ID=465
echo NEW_RESERVE_CODE_ID=466
